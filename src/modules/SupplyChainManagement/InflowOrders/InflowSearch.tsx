...
import { INBOUND_ORDER_PENDING_STATUS } from "../utils/constants";
import { toast } from "sonner";

export default function InflowSearch({setFilters, filters, isLoading, completed=false}:TSearchProps){
                        ...
                        <div className="col-span-2">
                            <FormField
                                ...
                                <FormItem>
                                    ...
                                    <SelectContent>
                                        {INBOUND_ORDER_PENDING_STATUS.map((item, idx) => (

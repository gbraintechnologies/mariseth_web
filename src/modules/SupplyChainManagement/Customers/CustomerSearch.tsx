...
import { customerSearchSchema } from "../../Accounting/utils/validations";

export default function CustomerSearch({setFilters, isLoading, refetch}:TSearchProps){
                            ...
                            <FormItem>
                                <FormControl>
                                    <div className="relative">
                                        ...
                                        <Input className="px-10" placeholder="Search with customer ID, customer name" {...field} />
                                    </div>
                                </FormControl>
                                <FormMessage />
                            </FormItem>

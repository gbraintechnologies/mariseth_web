...
import { helpSearchSchema } from "./utils/validations";

export default function HelpSearch({setFilters, isLoading, refetch}:TSearchProps){

    const form = useForm<z.infer<typeof helpSearchSchema>>({
        resolver: zodResolver(helpSearchSchema),
    });

    function onSubmit(values: z.infer<typeof helpSearchSchema>) {
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            ...
                                            <Input placeholder="Search Name" className="px-10" {...field} />
                                        </div>
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>

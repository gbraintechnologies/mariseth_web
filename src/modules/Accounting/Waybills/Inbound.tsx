...
import InboundSearch from "./InboundSearch";
...
export default function Inbound(){
        ...
        { header: "Action", accessorKey: "vehicle",
            cell: (_row) => {
                ...
                return (
                    <div>
                        {view_waybill ?
                        <Link className="cursor-pointer" href={`${routeTo.accountingViewWaybill}/${row?.id}/?order_type=inflow`} >
    ...
    return(
        <div>
            ...
            <div>
                <CustomTable 
                    searchFilter={<InboundSearch setFilters={setFilters} refetch={refetch} isLoading={isLoading} />}
                    columns={columns} 
                    data={data?.results || []} 

         ...
         <div className="space-y-5">
            ...
            <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-2">
                    ...
                    <AccordionContent className="border p-5 border-t-0 rounded-b-lg">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <TextLabel title={"Use of Fertilizers"} subTitle={defaultData?.use_of_fertilizers as any} variant="dark"/>
                            <TextLabel title={"Farming Methods"} subTitle={defaultData?.farming_methods as any} variant="dark"/>

...
import { z } from "zod";
import { searchProductSchema } from "../utils/validations";
...
import { seasonStatus } from "../utils/constants";
import { toast } from "sonner";

export default function CropsSearch({setFilters, filters, isLoading}:TSearchProps){
    ...
    function onSubmit(values: z.infer<typeof searchProductSchema>) {
                            ...
                            <FormItem>
                                <FormControl>
                                    <div className="relative">
                                        ...
                                        <Input className="px-10" placeholder="Search with product ID, product name" {...field} />
                                    </div>
                                </FormControl>
                                <FormMessage />
                            </FormItem>

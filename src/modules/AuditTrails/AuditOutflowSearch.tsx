...
import { inflowSearchSchema } from "../SupplyChainManagement/utils/validations";

export default function AuditOutflowSearch({setFilters, filters, isLoading, completed}:TSearchProps){

...
export const creditSchema = z.object({
  farmer: z.string(),
  input_credit_category: z.string(),
  input_credit: z.string(),
  quantity: z.string(),
  quantity_metric: z.string(),
  notes: z.string().optional(),
});

export const inputCreditProcurementSchema = z.object({
  category: z.string(),
  input_credit: z.string(),
...
export const inputCreditSchema = z.object({
  name: z.string(),
  category: z.string(),
  weight: z.string(),
  price: z.string()
...
export const inputCreditSearchSchema = z.object({
  query: z.string().optional(),
  category: z.string().optional(),
});
